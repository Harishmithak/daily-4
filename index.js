...
function validation() {
    ...
    var fname = document.register.fathername.value;
...
function display(name, dob, gender, fname, address, mobile, phone, email, college, mark, interest) {
    ...
    document.write("<p>Father's Name:" + fname + "</p>");
    ...
    document.write("<p>personal interest:</p>");
if (dancing) {
